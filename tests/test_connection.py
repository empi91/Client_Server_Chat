...
class TestConnection(unittest.TestCase):
    ...
    def test_server_socket_reuse(self):
        ...
        self.assertEqual(option_value, 1, "SO_REUSEADDR should be set for server sockets")
    ...
    def test_connection_context_management(self):
        ...
        self.assertTrue(hasattr(self.connection, '__enter__'), 
                       "Connection should implement context management (__enter__)")
        self.assertTrue(hasattr(self.connection, '__exit__'), 
