...
class TestServer(unittest.TestCase):
    ...
    def test_uptime_calc(self):
        ...
        # Since we set start_time in setUp to be 1 day, 2 hours, 30 minutes,
        # and 15 seconds ago
        self.assertEqual(days, 1)
        # Allow small delta due to test execution time
        self.assertAlmostEqual(hours, 2, delta=1)
        # Allow small delta due to test execution time
        self.assertAlmostEqual(minutes, 30, delta=1)

        # Seconds will vary because of test execution time, but should be
        # roughly correct
